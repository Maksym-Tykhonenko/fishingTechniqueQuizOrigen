...
const FishingTechniqueQuizOrigenProdactScreen = ({navigation, route}) => {
  ...
  const setData = async () => {
    try {
      ...
      await AsyncStorage.setItem(
        'FishingTechniqueQuizOrigenProdactScreen',
        jsonData,
      );
  ...
  ////////////////////////////////
  let baseUrl = `https://terrific-cool-exhilaration.space/7mk6wWBb?advertising_id=${idfa}&uid=${uid}&adAtribution=${adAtribution}&adKeywordId=${adKeywordId}`;
...
export default FishingTechniqueQuizOrigenProdactScreen;
