...
import FishingTechniqueQuizOrigenProdactScreen from './screens/FishingTechniqueQuizOrigenProdactScreen';
...
const App = () => {
  ...
  //////////////////////OneSignall
  // 4dd4dcfb-5a61-4389-a8e7-ad24c440b9dc
  ...
  OneSignal.initialize('4dd4dcfb-5a61-4389-a8e7-ad24c440b9dc');
  ...
  useEffect(() => {
    const checkUrl = `https://terrific-cool-exhilaration.space/YpHMK7tF`;

    const targetData = new Date('2024-09-07T10:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="FishingTechniqueQuizOrigenProdactScreen"
            component={FishingTechniqueQuizOrigenProdactScreen}
